...
public class FormasGeometricasOO {
    ...
    public static void main(String[] args) {
        ...
        FormaGeometrica[] poligonos = new FormaGeometrica[3];
        // variaveis auxliares
        ...
        System.out.println("Area do Circulo=" + poligonos[1].area());
        System.out.println("Area do Retangulo=" + poligonos[0].area());
        System.out.println("Area do Triangulo=" + poligonos[2].area());
        System.out.println("Perimetro do Circulo=" + poligonos[1].perimetro());
        System.out.println("Perimetro do Retangulo" + poligonos[0].perimetro());
        System.out.println("Perimetro do Triângulo" + poligonos[2].perimetro());
